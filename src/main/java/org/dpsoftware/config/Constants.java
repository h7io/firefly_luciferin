...
public class Constants {
    ...
    public static final String GSTREAMER_PIPELINE_LINUX_NVIDIA = "ximagesrc startx={0} endx={1} starty={2} endy={3} ! nvvideoconvert";
    public static final String GSTREAMER_PIPELINE_LINUX_NVIDIA_SCALE = "ximagesrc startx={0} endx={1} starty={2} endy={3} ! videoscale ! nvvideoconvert";
